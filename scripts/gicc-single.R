...
boxplot(dboth, names=c("single-app",""),col=colors2,ylab="percentage (instance view)",range=0,cex.axis=0.4,lwd=0.3,cex.lab=0.5)
...
boxplot(dataextraboth, names=datatypenames,col=colors3,ylab="percentage (instance view)",range=0,cex.axis=0.4,lwd=0.3,cex.lab=0.5, medcol='black')
...
boxplot(giccboth, names=icctypenames,col=colors4,ylab="percentage (instance view)",range=0,cex.axis=0.4,lwd=0.3,cex.lab=0.5,medcol='black')
