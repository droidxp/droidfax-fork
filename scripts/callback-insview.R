...
pdf("./callback-dins.pdf",width=4.8,height=3.0)
boxplot(dcbins, names=c("lifecycle method","event handler"),col=colors2,xlab="percentage of calls",ylab="callback",range=0,horizontal=TRUE, cex.axis=0.4,lwd=0.3,cex.lab=0.5)
