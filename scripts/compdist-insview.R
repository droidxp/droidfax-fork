...
pdf("./compdist-ins-d.pdf",width=4.8,height=3.76)
boxplot(dpmins, names=xnames,col=colors,xlab="percentage of calls",ylab='component',horizontal=TRUE, range=0,cex.axis=0.4,lwd=0.3,cex.lab=0.5)
