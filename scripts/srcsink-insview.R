...
pdf("./srcsink-dins.pdf",width=4.8,height=3.0)
boxplot(dsusiins, names=c("source","sink"),col=colors2,xlab="percentage of calls",ylab="sensitive access", horizontal=TRUE, range=0,cex.axis=0.4,lwd=0.3,cex.lab=0.5)
