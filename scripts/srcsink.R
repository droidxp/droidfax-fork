...
boxplot(ssusi, names=c("source","sink"),col=colors2,ylab="percentage (static view)",range=0,cex.axis=0.4,lwd=0.3,cex.lab=0.5)
...
boxplot(dsusiins, names=c("source","sink"),col=colors2,ylab="percentage (dynamic view)",range=0,cex.axis=0.4,lwd=0.3,cex.lab=0.5)
...
boxplot(drisk[,3:4], names=c("risky source","risky sink"),col=colors2,ylab="percentage (dynamic view)",range=0,cex.axis=0.4,lwd=0.3,cex.lab=0.5)
