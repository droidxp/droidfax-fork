...
resultdir=/home/hcai/testbed/$resdir/ICCReport/$linkage
mkdir -p $resultdir
...
do
	...
	bash /home/hcai/testbed/ICCReport.sh \
		$APKDIR/$i/s.apk \
...
mv /home/hcai/testbed/{gicc.txt,dataicc.txt,extraicc.txt,icclink.txt,icccov.txt,bothdataicc.txt,iccfeatures.txt} \
   $resultdir	
